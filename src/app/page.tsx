...
const texts = {
  no: {
    ...
    underground: { floor: "Kjelleren", title: "The Underground", sub: "You weren't supposed to find this place.", events: "Kommende events", book: "Book bord" },
  ...
  en: {
    ...
    underground: { floor: "Basement", title: "The Underground", sub: "You weren't supposed to find this place.", events: "Upcoming events", book: "Book a table" },
      ...
      <footer className="snap-section flex flex-col justify-between bg-black px-6 py-12 sm:px-12">
        <div className="flex flex-col gap-12">
          ...
          <div className="border-t border-white/8 pt-8">
            <h3 className="font-cormorant mb-4 text-[0.6rem] tracking-[0.4em] uppercase" style={{ color: "var(--brand)" }}>
              @hukenbrygg
            </h3>
